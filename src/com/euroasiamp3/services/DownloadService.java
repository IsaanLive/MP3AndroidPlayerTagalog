...
import com.euroasia.ph.DownloadingActivity;
import com.euroasia.ph.R;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("I-download Kinansela","Kinansela: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("I-download Nabigong","Nabigong: "+filename,filename); 
				http--;
				...
				regularNotif("I-download Nakumpleto","Tapos: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "I-click ang Narito Upang Tingnan ang Isinasagawa", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
