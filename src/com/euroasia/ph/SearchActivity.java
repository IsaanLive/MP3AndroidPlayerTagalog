...
public class SearchActivity extends ListActivity {
    ...
    public void startsearch(){
		...
		toastmake("Naghahanap Para sa: "+searchstring);
	...
	private class RetrieveSearch extends AsyncTask<Void, Void, Void>{
		...
		protected void onCancelled() {		
			...
			TextView failresults = (TextView)findViewById(R.id.failresults);
			failresults.setText("Paghahanap ay nakansela");
		...
		protected void onPreExecute() {
			...
			cancelDialog.setMessage("Naghahanap ng Para Kanta ...");
		...
		protected void onPostExecute(Void result) {
			if(ia == 0 && fail == 0){
		        ...
		        if(!isInternetConnectionActive(getApplicationContext())) {
					failresults.setText("Lumilitaw na hindi mo na magkaroon ng isang aktibong Koneksyon sa Internet o magkaroon ng isang Mahinang Signal. Mangyaring i-on ang iyong wifi o data at subukan muli.");
		        }else{
					failresults.setText("Walang Natagpuang Mga resulta");
		        }
			}else if(ia == 0 && fail > 0){
				fail = 0;
		        ...
		        if(!isInternetConnectionActive(getApplicationContext())) {
					...
					failresults.setText("Mukhang bilang nagkaroon ng error habang sinusubukang upang maghanap. Mangyaring subukang muli");
		        }
			}else{
				setListAdapter(adapter);
			}
		...
		public void getDilandau(String search) throws IOException, MalformedURLException, NullPointerException{
			...
			if(!sb.toString().contains("Walang kanta ang nakita")){
