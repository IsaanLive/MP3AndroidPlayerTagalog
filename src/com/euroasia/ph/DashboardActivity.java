...
public class DashboardActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		share.setOnClickListener(new OnClickListener() {
        	public void onClick(View v) {
				...
				i.putExtra(Intent.EXTRA_SUBJECT, "MP3 Downloader");
				i.putExtra(Intent.EXTRA_TEXT, "Nagtatampok ng isang malakas na function sa paghahanap, "+getString(R.string.app_name)+" ay nagbibigay sa iyo ng milyun-milyong mga de-kalidad na kanta. Maaari mong alinman-enjoy ang mga ito sa online o makakuha ng libreng pag-download. Makaranas ng isang kapistahan sa pandinig ngayon! "+getString(R.string.app_name)+" Download Link: https://market.android.com/details?id="+getString(R.string.market_url));
				startActivity(Intent.createChooser(i, "Ibahagi Application"));
        	}
		});
		...
		if(!isInternetConnectionActive(getApplicationContext())) {
			...
			builder.setMessage("Kailangan mo ng isang aktibong koneksyon sa internet upang gamitin ang karamihan ng mga tampok sa app. Mangyaring pumunta sa iyong mga setting at paganahin ang wifi!")
				   .setCancelable(false)
				   .setPositiveButton("Mga Setting", new DialogInterface.OnClickListener() {
        	       ...
        	       .setNegativeButton("Isara", new DialogInterface.OnClickListener() {
        	           public void onClick(DialogInterface dialog, int id) {
        	                dialog.cancel();
        	           }
        	       });
	...
	public void rateapp(){		
		...
		if(hasBeenShown == false){
			String title = "Rate sa amin sa Android Market";
			
			String message = "Minamahal naming user, Kung gusto mo ang aming application, mangyaring bigyan kami ng 5 bituin. Iyong napapanatiling suporta ay ang pinagmulan ng aming pagpapabuti.";
 
			AlertDialog.Builder builder = new AlertDialog.Builder(this)
					.setTitle(title)
					.setMessage(message)
					.setPositiveButton("Bumoto", new Dialog.OnClickListener() {
					...
					.setNegativeButton("Kanselahin", new Dialog.OnClickListener() {
